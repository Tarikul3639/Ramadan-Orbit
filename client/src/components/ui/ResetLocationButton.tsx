...
const ResetLocation = () => {
  const handleReset = () => {
    localStorage.removeItem("user_location_coords");
    localStorage.removeItem("user_location_coords_time");
    localStorage.removeItem("user_location_district");
    localStorage.removeItem("user_location_district_time");
  ...
  return (
    ...
    >
      ...
      <MapPin className="size-3 md:size-4 text-primary transition-colors duration-200" />
